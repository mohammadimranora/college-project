	...
	<div class="row">
		...
		<div class="col-sm-12 col-xs-12" id="PrintArea">
			<div class="panel panel-primary">
				<div class="panel-heading"><center>Admission Letter</center></div>
					<table class="table table-responsive" style="font-size: 16px">
						<tr>
							<th><span><center>Admission Confirmation Letter</center></span></th>
						</tr>
						<tr>
							<td style="font-weight: bold;">Date:&nbsp<?php $date=date("d/m/Y"); echo $date?></td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<p style="text-align: justify;">
									<br>
									I am pleased to inform you that you have been admitted to the<span style="color: blue; font-weight: bold; text-transform: uppercase;"> <?php echo $datarow2[2];?></span> program at <span style="color: blue; font-weight: bold; text-transform: uppercase;"> <?php echo $datarow2[1];?></span> for the <span style="color: blue; font-weight: bold; text-transform: uppercase;"> <?php echo date("Y"); echo "-"; echo date("y")+1; ?></span> academic year beginning August <?php $date=date("Y"); echo $date?>. Your enrollment no is <span style="color: blue; font-weight: bold; text-transform: uppercase;"> <?php echo $datarow2[0];?></span> and Admission date is <span style="color: blue; font-weight: bold; text-transform: uppercase;"> <?php echo $datarow2[3];?></span> <br><br>
